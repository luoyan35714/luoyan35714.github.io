...
public static void main(String[] args) {
		 ...
		 * 0000 0000 0000 0000 0000 0000 0000 0111 (7的原码反码补码)左移3位,低位补0
		 ...
		 * 1111 1111 1111 1111 1111 1111 1100 0111 (-56)的反码
		 * 1111 1111 1111 1111 1111 1111 1100 1000 (-56)的反码加一获得补码
		 * 1111 1111 1111 1111 1111 1111 1111 1001 (-56)的补码右移三位,高位补1得到结果的补码
		 * 1111 1111 1111 1111 1111 1111 1111 1000 结果补码减一得到反码
		 * 1000 0000 0000 0000 0000 0000 0000 0111 反码符号位不变，其他按位取反得到结果的原码换算成10进制为(-7)
		 */
		System.out.println("右移3位:" + (-56 >> 3));
		
		/**
		 * 3.无符号右移-负数(其中左移只有有符号左移，原因是不管有符号，还是无符号，都是在右边补0所以没有区别)
		 * 1000 0000 0000 0000 0000 0000 0011 1000 (-56的原码)
		 * 1111 1111 1111 1111 1111 1111 1100 0111 (-56)的反码
		 * 1111 1111 1111 1111 1111 1111 1100 1000 (-56)的反码加一获得补码
		...
		/**
		 * 4.无符号右移-正数
		 * 0000 0000 0000 0000 0000 0000 0011 1000 (56的原码反码补码)右移3位,高位补0
		...
		/**
		 * 9.位非
		 * 0000 0000 0000 0000 0000 0000 0000 0101 From (5)(Java中数字按照补码形式存在，所以5的补码是本身)
		 * 1111 1111 1111 1111 1111 1111 1111 1010 取反得到结果的补码(结果的补码是负数)
		 * 1111 1111 1111 1111 1111 1111 1111 1001 补码-1=反码
		 * 1000 0000 0000 0000 0000 0000 0000 0110 符号位不变，其他按位取反得到原码，结果的源码换算成10进制为（-6）
		 */
